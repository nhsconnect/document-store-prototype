...
const HomePage = () => {
  const isMultiStepUploadPathEnabled = useFeatureToggle('PDS_TRACE_FOR_UPLOAD_ENABLED')
  const uploadPathHref = isMultiStepUploadPathEnabled ? "/upload/patient-trace" : "/upload"
  return (
    <>
