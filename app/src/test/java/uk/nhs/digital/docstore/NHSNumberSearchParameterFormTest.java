...
public class NHSNumberSearchParameterFormTest {
    ...
    void validateDoesNotThrowExceptionWhenSearchParameterIsPresentAndValid() {
        Map<String, String> searchParameters =
                Map.of("subject:identifier", "https://fhir.nhs.uk/Id/nhs-number|9000000009");
        NHSNumberSearchParameterForm nhsNumberSearchParameterForm =
                new NHSNumberSearchParameterForm(searchParameters);
    ...
    @Test
    void
            constructorThrowsMissingSearchParametersExceptionWhenSubjectIdentifierParameterIsMissing() {
    ...
    void validateThrowsInvalidSubjectIdentifierExceptionWhenAnInvalidSubjectIdentifierIsInput() {
        Map<String, String> searchParameters =
                Map.of("subject:identifier", "https://fhir.nhs.uk/Id/nhs-number|90000");
        NHSNumberSearchParameterForm nhsNumberSearchParameterForm =
                new NHSNumberSearchParameterForm(searchParameters);
    ...
    @Test
    void
            validateThrowsInvalidSubjectIdentifierExceptionWhenAnInvalidSubjectIdentifierIsBlankInput() {
        Map<String, String> searchParameters =
                Map.of("subject:identifier", "https://fhir.nhs.uk/Id/nhs-number|");
        NHSNumberSearchParameterForm nhsNumberSearchParameterForm =
                new NHSNumberSearchParameterForm(searchParameters);
    ...
    @Test
    void
            validateThrowsUnrecognisedSubjectIdentifierSystemExceptionWhenAnUnrecognisedSubjectIdentifierSystemIsInput() {
        Map<String, String> searchParameters =
                Map.of("subject:identifier", "unrecognised-subject-identifier-system|9000000009");
        NHSNumberSearchParameterForm nhsNumberSearchParameterForm =
                new NHSNumberSearchParameterForm(searchParameters);
