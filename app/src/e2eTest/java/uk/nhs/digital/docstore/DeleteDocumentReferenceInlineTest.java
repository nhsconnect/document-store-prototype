...
public class DeleteDocumentReferenceInlineTest {
    ...
    void setUp() {
        ...
        var documentDeletionService = new DocumentDeletionService(
                ...
                new DocumentStore(
                        AmazonS3ClientBuilder
                                .standard()
                                .withEndpointConfiguration(new AwsClientBuilder.EndpointConfiguration(AWS_ENDPOINT, AWS_REGION))
        ...
        deleteDocumentReferenceHandler = new DeleteDocumentReferenceHandler(apiConfig, documentDeletionService);
    }

    //TODO: Use DocumentMetadataStore and DocumentStore to interact with AWS resources so that we can perform arrange and assert + change test name
    @Test
