...
public class CreateDocumentReferenceE2eTest {
    ...
    void returnsCreatedDocumentReference() throws IOException, InterruptedException {
        String expectedDocumentReference = utilsE2eTest.getContentFromResource("create/CreatedDocumentReference.json");
        var requestContent = utilsE2eTest.getContentFromResource("create/CreateDocumentReferenceRequest.json");
