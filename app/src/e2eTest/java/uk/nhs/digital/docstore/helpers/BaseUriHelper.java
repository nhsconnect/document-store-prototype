...
public class BaseUriHelper {
  ...
  public static URI getBaseUri() {
    ...
    List<RestApi> apis = amazonApiGatewayClient.getRestApis(new GetRestApisRequest()).getItems();
    ...
    List<Stage> stages =
        amazonApiGatewayClient
            .getStages(
                new GetStagesRequest().withRestApiId(restApiId).withDeploymentId(deploymentId))
            .getItem();
