...
public class DeleteDocumentReferenceE2eTest {
    ...
    void shouldMarkADocumentsRelatedToTheNhsNumberAsDeletedAndReturnSuccessfulMessage()
        ...
        var nhsNumberParameter =
                URLEncoder.encode(
                        "https://fhir.nhs.uk/Id/nhs-number|" + nhsNumber, StandardCharsets.UTF_8);
        ...
        var deleteDocumentReferenceResponse =
                newHttpClient()
                        .send(deleteDocumentReferenceRequest, HttpResponse.BodyHandlers.ofString());
    ...
    private String getContentFromResource() throws IOException {
        ...
        File file =
                new File(
                        classLoader
                                .getResource("delete/successful-delete-response.json")
                                .getFile());
